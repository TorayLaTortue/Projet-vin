...
INSERT INTO public.vin (nom, image, region, famille, annee, format, promotion, prix, date_suppression)
VALUES
    ('Vin1', 'image1.jpg', 'Bordeaux', 'Famille1', '2020-01-01', '750ml', 0.1, 20, NULL),
    ('Vin2', 'image2.jpg', 'Bourgogne', 'Famille2', '2019-01-01', '750ml', 0.2, 25, NULL),
    ('Vin3', 'image3.jpg', 'Champagne', 'Famille3', '2018-01-01', '750ml', 0.15, 30, NULL);
...
INSERT INTO public.depot (reference_depot, nom_depot, adresse, reference_vin, quantite, reference_fournisseur, date_suppression)
VALUES
    (1, 'Depot1', 1, 1, 100, 1, NULL),
    (2, 'Depot2', 2, 2, 400, 2, NULL),
    (3, 'Depot3', 3, 3, 200, 3, NULL);
